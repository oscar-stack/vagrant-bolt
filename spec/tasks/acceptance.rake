namespace :acceptance do
  ...
  task :components do
    exec("vagrant-spec components --config=spec/vagrant-spec.config.rb")
  end
  ...
  task :setup do
    ...
    box_path = File.join('spec', 'acceptance', 'artifacts', "#{provider_name}.box")
  ...
  task :run do
    args = [
      "--config=spec/vagrant-spec.config.rb",
    ]
